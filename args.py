...
def get_parser():
    ...
    # REFER
    parser.add_argument('--refer_data_root', default='/home/yzq/mnt/data/coco', help='REFER dataset root directory')
    ...
    parser.add_argument("--softmax_T",default=1.0,type=float)
    ...
    parser.add_argument('--div_loc', default=0., type=float)
    parser.add_argument("--norm_prior", action="store_true", default=False)
    parser.add_argument('--gradient_accumulation_steps', default=1, type=int)
    parser.add_argument('--K_Iters', default=1, type=int)
    ...
    parser.add_argument("--save_train_pseudo_dir", default=None, type=str)
    parser.add_argument("--save_code", default=None, type=str)
    parser.add_argument("--amp_training",action="store_true", default=False)
    ...
    parser.add_argument("--clip_bg", action="store_true", default=False)
    parser.add_argument("--clip_fg", action="store_true", default=False)
    return parser
